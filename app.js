document.addEventListener('DOMContentLoaded', () => {
    ...
    window.generateReport = () => {
        ...
        doc.setFontSize(14);
        doc.text("AI-Based Cardiovascular Risk Prediction Report", 20, 30);
        ...
        doc.text("© Cardio70 | All Rights Reserved", 150, 292);
    ...
    function showToast(message, type = 'success') {
        ...
        toast.style.borderColor = type === 'error' ? 'var(--color-danger)' : 'var(--color-success)';
